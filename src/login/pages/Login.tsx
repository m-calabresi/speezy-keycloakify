                        ...
                        <form
                            ...
                            <div
                                ...
                                <button
                                    ...
                                    className={`${kcClsx("kcButtonClass", "kcButtonPrimaryClass", "kcButtonBlockClass", "kcButtonLargeClass")} group`}
                                    name="login"
                                    id="kc-login"
                                    type="submit">
                                    <span>{msgStr("doLogIn")}</span>
                                    <ArrowRightIcon className="kcButtonIconClass kcButtonIconPrimaryClass" />
                                </button>
                            </div>
                        </form>
                    )}
